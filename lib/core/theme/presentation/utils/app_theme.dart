...
enum AppThemeMode {
  ...
  ThemeData getThemeData(String fontFamily, {required bool supportsEdgeToEdge}) {
    return AppTheme(themeMode: this, supportsEdgeToEdge: supportsEdgeToEdge).getThemeData(fontFamily);
  }
  ...
  SystemUiOverlayStyle overlayStyle({
    ...
    return _baseOverlayStyle.copyWith(
      ...
      systemNavigationBarColor: supportsEdgeToEdge ? systemNavBarColor : olderAndroidSystemNavBarColor,
