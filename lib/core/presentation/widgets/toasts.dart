...
import 'package:yagodmarket/core/infrastructure/services/connection_stream_service.dart';
...
import 'package:yagodmarket/core/theme/presentation/utils/app_static_colors.dart';
        ...
        children: <Widget>[
          ...
          Text(
            connectionStatus == ConnectionStatus.disconnected
                ...
                : tr(context).you_are_back_online,
            style: TextStyles.f16SemiBold(context).copyWith(color: AppStaticColors.lightBlack),
          ),
        ],
      ),
