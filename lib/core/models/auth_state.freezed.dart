...
class __$$AuthImplCopyWithImpl<$Res> extends _$AuthCopyWithImpl<$Res, _$AuthImpl> implements _$$AuthImplCopyWith<$Res> {
  __$$AuthImplCopyWithImpl(_$AuthImpl _value, $Res Function(_$AuthImpl) _then) : super(_value, _then);
...
class _$AuthImpl implements _Auth {
  const _$AuthImpl({required this.userId, required this.accessToken, required this.refreshToken});
...
abstract class _Auth implements Auth {
  const factory _Auth(
      {required final int userId, required final String accessToken, required final String refreshToken}) = _$AuthImpl;
