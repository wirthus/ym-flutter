...
import 'package:yagodmarket/ui/pages/tabs/map/widgets/control_button.dart';
...
class _ClusterizedPlacemarkCollectionExampleState extends State<_ClusterizedPlacemarkCollectionExample> {
  ...
  Future<Uint8List> _buildClusterAppearance(Cluster cluster) async {
    ...
    final textPainter = TextPainter(
        text: TextSpan(text: cluster.size.toString(), style: const TextStyle(color: Colors.black, fontSize: 50)),
              ...
              children: <Widget>[
                      ...
                      final mapObject = ClusterizedPlacemarkCollection(
                        ...
                        placemarks: [
                          PlacemarkMapObject(
                              ...
                              icon: PlacemarkIcon.single(PlacemarkIconStyle(
                                  image: BitmapDescriptor.fromAssetImage('lib/assets/place.png'), scale: 1))),
                          PlacemarkMapObject(
                ...
                ControlButton(
                    onPressed: () async {
                      ...
                      final mapObject =
                          mapObjects.firstWhere((el) => el.mapId == mapObjectId) as ClusterizedPlacemarkCollection;
