...
/// * [infoRu]
@BuiltValue()
abstract class UserPrivateEntity
    implements Built<UserPrivateEntity, UserPrivateEntityBuilder> {
  ...
  factory UserPrivateEntity([void updates(UserPrivateEntityBuilder b)]) =
      _$UserPrivateEntity;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UserPrivateEntityBuilder b) => b..mobile = null;

  @BuiltValueSerializer(custom: true)
  static Serializer<UserPrivateEntity> get serializer =>
      _$UserPrivateEntitySerializer();
}

class _$UserPrivateEntitySerializer
    implements PrimitiveSerializer<UserPrivateEntity> {
  @override
