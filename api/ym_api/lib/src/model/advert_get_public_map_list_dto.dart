...
@BuiltValue()
abstract class AdvertGetPublicMapListDto
    implements
        Built<AdvertGetPublicMapListDto, AdvertGetPublicMapListDtoBuilder> {
  ...
  factory AdvertGetPublicMapListDto(
          [void updates(AdvertGetPublicMapListDtoBuilder b)]) =
      _$AdvertGetPublicMapListDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AdvertGetPublicMapListDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AdvertGetPublicMapListDto> get serializer =>
      _$AdvertGetPublicMapListDtoSerializer();
}

class _$AdvertGetPublicMapListDtoSerializer
    implements PrimitiveSerializer<AdvertGetPublicMapListDto> {
  @override
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.filters != null) {
      ...
      yield serializers.serialize(
        object.filters,
        specifiedType:
            const FullType(BuiltList, [FullType(AdvertPublicFilterDto)]),
      );
    }
