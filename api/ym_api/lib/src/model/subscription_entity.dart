...
/// * [regionIds]
@BuiltValue()
abstract class SubscriptionEntity
  ...
  factory SubscriptionEntity([void updates(SubscriptionEntityBuilder b)]) =
      _$SubscriptionEntity;
...
class _$SubscriptionEntitySerializer
    implements PrimitiveSerializer<SubscriptionEntity> {
  @override
