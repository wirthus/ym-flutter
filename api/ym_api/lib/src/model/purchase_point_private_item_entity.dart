...
/// * [updatedAt]
@BuiltValue()
abstract class PurchasePointPrivateItemEntity
    implements
        Built<PurchasePointPrivateItemEntity,
  ...
  factory PurchasePointPrivateItemEntity(
          [void updates(PurchasePointPrivateItemEntityBuilder b)]) =
      _$PurchasePointPrivateItemEntity;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PurchasePointPrivateItemEntityBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PurchasePointPrivateItemEntity> get serializer =>
      _$PurchasePointPrivateItemEntitySerializer();
}

class _$PurchasePointPrivateItemEntitySerializer
    implements PrimitiveSerializer<PurchasePointPrivateItemEntity> {
  @override
