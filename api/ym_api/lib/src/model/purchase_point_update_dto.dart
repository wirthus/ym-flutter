...
/// * [address]
@BuiltValue()
abstract class PurchasePointUpdateDto
    implements Built<PurchasePointUpdateDto, PurchasePointUpdateDtoBuilder> {
  ...
  factory PurchasePointUpdateDto(
          [void updates(PurchasePointUpdateDtoBuilder b)]) =
      _$PurchasePointUpdateDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PurchasePointUpdateDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PurchasePointUpdateDto> get serializer =>
      _$PurchasePointUpdateDtoSerializer();
}

class _$PurchasePointUpdateDtoSerializer
    implements PrimitiveSerializer<PurchasePointUpdateDto> {
  @override
