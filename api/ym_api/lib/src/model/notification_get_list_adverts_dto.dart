...
/// * [subtypes]
@BuiltValue()
abstract class NotificationGetListAdvertsDto
    implements
        Built<NotificationGetListAdvertsDto,
  ...
  factory NotificationGetListAdvertsDto(
          [void updates(NotificationGetListAdvertsDtoBuilder b)]) =
      _$NotificationGetListAdvertsDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(NotificationGetListAdvertsDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<NotificationGetListAdvertsDto> get serializer =>
      _$NotificationGetListAdvertsDtoSerializer();
}

class _$NotificationGetListAdvertsDtoSerializer
    implements PrimitiveSerializer<NotificationGetListAdvertsDto> {
  @override
