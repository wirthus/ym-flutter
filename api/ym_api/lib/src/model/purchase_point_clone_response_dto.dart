...
/// * [advertIds]
@BuiltValue()
abstract class PurchasePointCloneResponseDto
    implements
        Built<PurchasePointCloneResponseDto,
  ...
  factory PurchasePointCloneResponseDto(
          [void updates(PurchasePointCloneResponseDtoBuilder b)]) =
      _$PurchasePointCloneResponseDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PurchasePointCloneResponseDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PurchasePointCloneResponseDto> get serializer =>
      _$PurchasePointCloneResponseDtoSerializer();
}

class _$PurchasePointCloneResponseDtoSerializer
    implements PrimitiveSerializer<PurchasePointCloneResponseDto> {
  @override
