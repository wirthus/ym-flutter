...
/// * [advertIds]
@BuiltValue()
abstract class AdvertBuyAddPurchasePointsResponseDto
    implements
        Built<AdvertBuyAddPurchasePointsResponseDto,
  ...
  factory AdvertBuyAddPurchasePointsResponseDto(
          [void updates(AdvertBuyAddPurchasePointsResponseDtoBuilder b)]) =
      _$AdvertBuyAddPurchasePointsResponseDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AdvertBuyAddPurchasePointsResponseDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AdvertBuyAddPurchasePointsResponseDto> get serializer =>
      _$AdvertBuyAddPurchasePointsResponseDtoSerializer();
}

class _$AdvertBuyAddPurchasePointsResponseDtoSerializer
    implements PrimitiveSerializer<AdvertBuyAddPurchasePointsResponseDto> {
  @override
