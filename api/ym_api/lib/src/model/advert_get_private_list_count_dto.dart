...
/// * [filters]
@BuiltValue()
abstract class AdvertGetPrivateListCountDto
    implements
        Built<AdvertGetPrivateListCountDto,
  ...
  factory AdvertGetPrivateListCountDto(
          [void updates(AdvertGetPrivateListCountDtoBuilder b)]) =
      _$AdvertGetPrivateListCountDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AdvertGetPrivateListCountDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AdvertGetPrivateListCountDto> get serializer =>
      _$AdvertGetPrivateListCountDtoSerializer();
}

class _$AdvertGetPrivateListCountDtoSerializer
    implements PrimitiveSerializer<AdvertGetPrivateListCountDto> {
  @override
