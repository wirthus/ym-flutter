...
/// * [mobile]
@BuiltValue()
abstract class UserPublicEntity
    implements Built<UserPublicEntity, UserPublicEntityBuilder> {
  ...
  factory UserPublicEntity([void updates(UserPublicEntityBuilder b)]) =
      _$UserPublicEntity;
  ...
  static Serializer<UserPublicEntity> get serializer =>
      _$UserPublicEntitySerializer();
}

class _$UserPublicEntitySerializer
    implements PrimitiveSerializer<UserPublicEntity> {
  @override
