...
/// * [companyInn]
@BuiltValue()
abstract class UserPrivateMobileEntity
    implements Built<UserPrivateMobileEntity, UserPrivateMobileEntityBuilder> {
  ...
  factory UserPrivateMobileEntity(
          [void updates(UserPrivateMobileEntityBuilder b)]) =
      _$UserPrivateMobileEntity;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UserPrivateMobileEntityBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<UserPrivateMobileEntity> get serializer =>
      _$UserPrivateMobileEntitySerializer();
}

class _$UserPrivateMobileEntitySerializer
    implements PrimitiveSerializer<UserPrivateMobileEntity> {
  @override
