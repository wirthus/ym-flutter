...
/// * [advertBuy]
@BuiltValue()
abstract class AdvertPublicFavoriteEntity
    implements
        Built<AdvertPublicFavoriteEntity, AdvertPublicFavoriteEntityBuilder> {
  ...
  factory AdvertPublicFavoriteEntity(
          [void updates(AdvertPublicFavoriteEntityBuilder b)]) =
      _$AdvertPublicFavoriteEntity;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AdvertPublicFavoriteEntityBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AdvertPublicFavoriteEntity> get serializer =>
      _$AdvertPublicFavoriteEntitySerializer();
}

class _$AdvertPublicFavoriteEntitySerializer
    implements PrimitiveSerializer<AdvertPublicFavoriteEntity> {
  @override
      ...
      switch (key) {
        ...
        case r'moderate':
          final valueDes = serializers.deserialize(
            value,
            specifiedType:
                const FullType(AdvertPublicFavoriteEntityModerateEnum),
...
class AdvertPublicFavoriteEntityModerateEnum extends EnumClass {
  ...
  static const AdvertPublicFavoriteEntityModerateEnum n0 =
      _$advertPublicFavoriteEntityModerateEnum_n0;
  @BuiltValueEnumConst(wireName: r'1')
  static const AdvertPublicFavoriteEntityModerateEnum n1 =
      _$advertPublicFavoriteEntityModerateEnum_n1;
  @BuiltValueEnumConst(wireName: r'2')
  static const AdvertPublicFavoriteEntityModerateEnum n2 =
      _$advertPublicFavoriteEntityModerateEnum_n2;

  static Serializer<AdvertPublicFavoriteEntityModerateEnum> get serializer =>
      _$advertPublicFavoriteEntityModerateEnumSerializer;

  const AdvertPublicFavoriteEntityModerateEnum._(String name) : super(name);

  static BuiltSet<AdvertPublicFavoriteEntityModerateEnum> get values =>
      _$advertPublicFavoriteEntityModerateEnumValues;
  static AdvertPublicFavoriteEntityModerateEnum valueOf(String name) =>
      _$advertPublicFavoriteEntityModerateEnumValueOf(name);
}
