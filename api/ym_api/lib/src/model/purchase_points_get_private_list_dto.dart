...
/// * [orderBy]
@BuiltValue()
abstract class PurchasePointsGetPrivateListDto
    implements
        Built<PurchasePointsGetPrivateListDto,
  ...
  factory PurchasePointsGetPrivateListDto(
          [void updates(PurchasePointsGetPrivateListDtoBuilder b)]) =
      _$PurchasePointsGetPrivateListDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PurchasePointsGetPrivateListDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PurchasePointsGetPrivateListDto> get serializer =>
      _$PurchasePointsGetPrivateListDtoSerializer();
}

class _$PurchasePointsGetPrivateListDtoSerializer
    implements PrimitiveSerializer<PurchasePointsGetPrivateListDto> {
  @override
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.orderBy != null) {
      ...
      yield serializers.serialize(
        object.orderBy,
        specifiedType:
            const FullType(PurchasePointsGetPrivateListDtoOrderByEnum),
      );
    }
  }
...
class PurchasePointsGetPrivateListDtoOrderByEnum extends EnumClass {
  ...
  static const PurchasePointsGetPrivateListDtoOrderByEnum name =
      _$purchasePointsGetPrivateListDtoOrderByEnum_name;
  @BuiltValueEnumConst(wireName: r'createdAt')
  static const PurchasePointsGetPrivateListDtoOrderByEnum createdAt =
      _$purchasePointsGetPrivateListDtoOrderByEnum_createdAt;

  static Serializer<PurchasePointsGetPrivateListDtoOrderByEnum>
      get serializer => _$purchasePointsGetPrivateListDtoOrderByEnumSerializer;

  const PurchasePointsGetPrivateListDtoOrderByEnum._(String name) : super(name);

  static BuiltSet<PurchasePointsGetPrivateListDtoOrderByEnum> get values =>
      _$purchasePointsGetPrivateListDtoOrderByEnumValues;
  static PurchasePointsGetPrivateListDtoOrderByEnum valueOf(String name) =>
      _$purchasePointsGetPrivateListDtoOrderByEnumValueOf(name);
}
