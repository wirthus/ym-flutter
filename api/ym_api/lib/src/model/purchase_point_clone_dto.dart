...
/// * [address]
@BuiltValue()
abstract class PurchasePointCloneDto
    implements Built<PurchasePointCloneDto, PurchasePointCloneDtoBuilder> {
  ...
  factory PurchasePointCloneDto(
      [void updates(PurchasePointCloneDtoBuilder b)]) = _$PurchasePointCloneDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PurchasePointCloneDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PurchasePointCloneDto> get serializer =>
      _$PurchasePointCloneDtoSerializer();
}

class _$PurchasePointCloneDtoSerializer
    implements PrimitiveSerializer<PurchasePointCloneDto> {
  @override
  final Iterable<Type> types = const [
    PurchasePointCloneDto,
    _$PurchasePointCloneDto
  ];
