...
/// * [purchasePointIds]
@BuiltValue()
abstract class AdvertBuyAddPurchasePointsDto
    implements
        Built<AdvertBuyAddPurchasePointsDto,
  ...
  factory AdvertBuyAddPurchasePointsDto(
          [void updates(AdvertBuyAddPurchasePointsDtoBuilder b)]) =
      _$AdvertBuyAddPurchasePointsDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AdvertBuyAddPurchasePointsDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AdvertBuyAddPurchasePointsDto> get serializer =>
      _$AdvertBuyAddPurchasePointsDtoSerializer();
}

class _$AdvertBuyAddPurchasePointsDtoSerializer
    implements PrimitiveSerializer<AdvertBuyAddPurchasePointsDto> {
  @override
