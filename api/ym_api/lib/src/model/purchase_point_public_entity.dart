...
/// * [region]
@BuiltValue()
abstract class PurchasePointPublicEntity
    implements
        Built<PurchasePointPublicEntity, PurchasePointPublicEntityBuilder> {
  ...
  factory PurchasePointPublicEntity(
          [void updates(PurchasePointPublicEntityBuilder b)]) =
      _$PurchasePointPublicEntity;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PurchasePointPublicEntityBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PurchasePointPublicEntity> get serializer =>
      _$PurchasePointPublicEntitySerializer();
}

class _$PurchasePointPublicEntitySerializer
    implements PrimitiveSerializer<PurchasePointPublicEntity> {
  @override
