...
/// * [destPurchasePointId]
@BuiltValue()
abstract class PurchasePointCloneAdvertsDto
    implements
        Built<PurchasePointCloneAdvertsDto,
  ...
  factory PurchasePointCloneAdvertsDto(
          [void updates(PurchasePointCloneAdvertsDtoBuilder b)]) =
      _$PurchasePointCloneAdvertsDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PurchasePointCloneAdvertsDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PurchasePointCloneAdvertsDto> get serializer =>
      _$PurchasePointCloneAdvertsDtoSerializer();
}

class _$PurchasePointCloneAdvertsDtoSerializer
    implements PrimitiveSerializer<PurchasePointCloneAdvertsDto> {
  @override
