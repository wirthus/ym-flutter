...
class PurchasePointCloneAdvertsDtoBuilder
  ...
  num? _destPurchasePointId;
  num? get destPurchasePointId => _$this._destPurchasePointId;
  set destPurchasePointId(num? destPurchasePointId) =>
