...
/// * [subtypes]
@BuiltValue()
abstract class SetReadNotificationDto
    implements Built<SetReadNotificationDto, SetReadNotificationDtoBuilder> {
  ...
  factory SetReadNotificationDto(
          [void updates(SetReadNotificationDtoBuilder b)]) =
      _$SetReadNotificationDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SetReadNotificationDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<SetReadNotificationDto> get serializer =>
      _$SetReadNotificationDtoSerializer();
}

class _$SetReadNotificationDtoSerializer
    implements PrimitiveSerializer<SetReadNotificationDto> {
  @override
