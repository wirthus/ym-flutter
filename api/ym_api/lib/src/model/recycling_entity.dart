...
/// * [name]
@BuiltValue()
abstract class RecyclingEntity
    implements Built<RecyclingEntity, RecyclingEntityBuilder> {
  ...
  factory RecyclingEntity([void updates(RecyclingEntityBuilder b)]) =
      _$RecyclingEntity;
  ...
  static Serializer<RecyclingEntity> get serializer =>
      _$RecyclingEntitySerializer();
}

class _$RecyclingEntitySerializer
    implements PrimitiveSerializer<RecyclingEntity> {
  @override
