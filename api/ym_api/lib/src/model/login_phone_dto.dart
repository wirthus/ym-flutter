...
/// * [requestId]
@BuiltValue()
abstract class LoginPhoneDto
    implements Built<LoginPhoneDto, LoginPhoneDtoBuilder> {
  ...
  factory LoginPhoneDto([void updates(LoginPhoneDtoBuilder b)]) =
      _$LoginPhoneDto;
  ...
  static Serializer<LoginPhoneDto> get serializer =>
      _$LoginPhoneDtoSerializer();
}
