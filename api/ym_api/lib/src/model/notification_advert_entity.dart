...
/// * [changePrice]
@BuiltValue()
abstract class NotificationAdvertEntity
    implements
        Built<NotificationAdvertEntity, NotificationAdvertEntityBuilder> {
  ...
  factory NotificationAdvertEntity(
          [void updates(NotificationAdvertEntityBuilder b)]) =
      _$NotificationAdvertEntity;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(NotificationAdvertEntityBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<NotificationAdvertEntity> get serializer =>
      _$NotificationAdvertEntitySerializer();
}

class _$NotificationAdvertEntitySerializer
    implements PrimitiveSerializer<NotificationAdvertEntity> {
  @override
  ...
  Iterable<Object?> _serializeProperties(
    ...
    yield object.subtype == null
        ...
        : serializers.serialize(
            object.subtype,
            specifiedType:
                const FullType.nullable(NotificationAdvertEntitySubtypeEnum),
          );
    yield r'advert';
    yield serializers.serialize(
      object.advert,
...
class NotificationAdvertEntitySubtypeEnum extends EnumClass {
  ...
  static const NotificationAdvertEntitySubtypeEnum purchaseAdvertChangedPrice =
  ...
  static const NotificationAdvertEntitySubtypeEnum purchaseAdvertChangedStatus =
  ...
  static const NotificationAdvertEntitySubtypeEnum
      purchaseAdvertChangedContent =
      _$notificationAdvertEntitySubtypeEnum_purchaseAdvertChangedContent;

  static Serializer<NotificationAdvertEntitySubtypeEnum> get serializer =>
      _$notificationAdvertEntitySubtypeEnumSerializer;

  const NotificationAdvertEntitySubtypeEnum._(String name) : super(name);

  static BuiltSet<NotificationAdvertEntitySubtypeEnum> get values =>
      _$notificationAdvertEntitySubtypeEnumValues;
  static NotificationAdvertEntitySubtypeEnum valueOf(String name) =>
      _$notificationAdvertEntitySubtypeEnumValueOf(name);
}
