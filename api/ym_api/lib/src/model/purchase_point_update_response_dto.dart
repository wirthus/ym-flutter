...
/// * [purchasePoint]
@BuiltValue()
abstract class PurchasePointUpdateResponseDto
    implements
        Built<PurchasePointUpdateResponseDto,
  ...
  factory PurchasePointUpdateResponseDto(
          [void updates(PurchasePointUpdateResponseDtoBuilder b)]) =
      _$PurchasePointUpdateResponseDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PurchasePointUpdateResponseDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PurchasePointUpdateResponseDto> get serializer =>
      _$PurchasePointUpdateResponseDtoSerializer();
}

class _$PurchasePointUpdateResponseDtoSerializer
    implements PrimitiveSerializer<PurchasePointUpdateResponseDto> {
  @override
