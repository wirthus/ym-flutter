...
/// * [purchasePointIds]
@BuiltValue()
abstract class AdvertBuyGetListFilter
    implements Built<AdvertBuyGetListFilter, AdvertBuyGetListFilterBuilder> {
  ...
  factory AdvertBuyGetListFilter(
          [void updates(AdvertBuyGetListFilterBuilder b)]) =
      _$AdvertBuyGetListFilter;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AdvertBuyGetListFilterBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AdvertBuyGetListFilter> get serializer =>
      _$AdvertBuyGetListFilterSerializer();
}

class _$AdvertBuyGetListFilterSerializer
    implements PrimitiveSerializer<AdvertBuyGetListFilter> {
  @override
