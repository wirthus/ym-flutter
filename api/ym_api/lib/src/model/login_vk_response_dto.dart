...
/// * [vk]
@BuiltValue()
abstract class LoginVkResponseDto
    implements Built<LoginVkResponseDto, LoginVkResponseDtoBuilder> {
  ...
  factory LoginVkResponseDto([void updates(LoginVkResponseDtoBuilder b)]) =
      _$LoginVkResponseDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(LoginVkResponseDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<LoginVkResponseDto> get serializer =>
      _$LoginVkResponseDtoSerializer();
}

class _$LoginVkResponseDtoSerializer
    implements PrimitiveSerializer<LoginVkResponseDto> {
  @override
