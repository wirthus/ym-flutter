...
/// * [advertBuyIds]
@BuiltValue()
abstract class PurchasePointRemoveAdvertsDto
    implements
        Built<PurchasePointRemoveAdvertsDto,
  ...
  factory PurchasePointRemoveAdvertsDto(
          [void updates(PurchasePointRemoveAdvertsDtoBuilder b)]) =
      _$PurchasePointRemoveAdvertsDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PurchasePointRemoveAdvertsDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PurchasePointRemoveAdvertsDto> get serializer =>
      _$PurchasePointRemoveAdvertsDtoSerializer();
}

class _$PurchasePointRemoveAdvertsDtoSerializer
    implements PrimitiveSerializer<PurchasePointRemoveAdvertsDto> {
  @override
