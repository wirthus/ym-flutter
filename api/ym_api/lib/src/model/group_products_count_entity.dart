...
/// * [productsCount]
@BuiltValue()
abstract class GroupProductsCountEntity
    implements
        Built<GroupProductsCountEntity, GroupProductsCountEntityBuilder> {
  ...
  factory GroupProductsCountEntity(
          [void updates(GroupProductsCountEntityBuilder b)]) =
      _$GroupProductsCountEntity;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(GroupProductsCountEntityBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<GroupProductsCountEntity> get serializer =>
      _$GroupProductsCountEntitySerializer();
}

class _$GroupProductsCountEntitySerializer
    implements PrimitiveSerializer<GroupProductsCountEntity> {
  @override
