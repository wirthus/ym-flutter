...
/// * [userId]
@BuiltValue()
abstract class VkAccessToken
    implements Built<VkAccessToken, VkAccessTokenBuilder> {
  ...
  factory VkAccessToken([void updates(VkAccessTokenBuilder b)]) =
      _$VkAccessToken;
  ...
  static Serializer<VkAccessToken> get serializer =>
      _$VkAccessTokenSerializer();
}
