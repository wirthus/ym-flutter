...
/// * [updatedAdvertCount]
@BuiltValue()
abstract class AdvertBuyUpdateResponseDto
    implements
        Built<AdvertBuyUpdateResponseDto, AdvertBuyUpdateResponseDtoBuilder> {
  ...
  factory AdvertBuyUpdateResponseDto(
          [void updates(AdvertBuyUpdateResponseDtoBuilder b)]) =
      _$AdvertBuyUpdateResponseDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AdvertBuyUpdateResponseDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AdvertBuyUpdateResponseDto> get serializer =>
      _$AdvertBuyUpdateResponseDtoSerializer();
}

class _$AdvertBuyUpdateResponseDtoSerializer
    implements PrimitiveSerializer<AdvertBuyUpdateResponseDto> {
  @override
