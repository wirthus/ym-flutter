...
/// * [subGroups]
@BuiltValue()
abstract class ProductGroupWithProductsEntity
    implements
        Built<ProductGroupWithProductsEntity,
  ...
  factory ProductGroupWithProductsEntity(
          [void updates(ProductGroupWithProductsEntityBuilder b)]) =
      _$ProductGroupWithProductsEntity;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ProductGroupWithProductsEntityBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ProductGroupWithProductsEntity> get serializer =>
      _$ProductGroupWithProductsEntitySerializer();
}

class _$ProductGroupWithProductsEntitySerializer
    implements PrimitiveSerializer<ProductGroupWithProductsEntity> {
  @override
    ...
    if (object.subGroups != null) {
      ...
      yield serializers.serialize(
        ...
        specifiedType: const FullType(
            BuiltList, [FullType(ProductSubGroupWithProductsEntity)]),
      );
    }
  }
