...
/// * [limit]
@BuiltValue()
abstract class AdvertGetLastPublicListDto
    implements
        Built<AdvertGetLastPublicListDto, AdvertGetLastPublicListDtoBuilder> {
  ...
  factory AdvertGetLastPublicListDto(
          [void updates(AdvertGetLastPublicListDtoBuilder b)]) =
      _$AdvertGetLastPublicListDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AdvertGetLastPublicListDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AdvertGetLastPublicListDto> get serializer =>
      _$AdvertGetLastPublicListDtoSerializer();
}

class _$AdvertGetLastPublicListDtoSerializer
    implements PrimitiveSerializer<AdvertGetLastPublicListDto> {
  @override
      ...
      switch (key) {
        ...
        case r'sortType':
          final valueDes = serializers.deserialize(
            value,
            specifiedType:
                const FullType(AdvertGetLastPublicListDtoSortTypeEnum),
...
class AdvertGetLastPublicListDtoSortTypeEnum extends EnumClass {
  ...
  static const AdvertGetLastPublicListDtoSortTypeEnum dateAsc =
      _$advertGetLastPublicListDtoSortTypeEnum_dateAsc;
  @BuiltValueEnumConst(wireName: r'date_desc')
  static const AdvertGetLastPublicListDtoSortTypeEnum dateDesc =
      _$advertGetLastPublicListDtoSortTypeEnum_dateDesc;
  @BuiltValueEnumConst(wireName: r'price_asc')
  static const AdvertGetLastPublicListDtoSortTypeEnum priceAsc =
      _$advertGetLastPublicListDtoSortTypeEnum_priceAsc;
  @BuiltValueEnumConst(wireName: r'price_desc')
  static const AdvertGetLastPublicListDtoSortTypeEnum priceDesc =
      _$advertGetLastPublicListDtoSortTypeEnum_priceDesc;
  @BuiltValueEnumConst(wireName: r'quantity_asc')
  static const AdvertGetLastPublicListDtoSortTypeEnum quantityAsc =
      _$advertGetLastPublicListDtoSortTypeEnum_quantityAsc;
  @BuiltValueEnumConst(wireName: r'quantity_desc')
  static const AdvertGetLastPublicListDtoSortTypeEnum quantityDesc =
      _$advertGetLastPublicListDtoSortTypeEnum_quantityDesc;

  static Serializer<AdvertGetLastPublicListDtoSortTypeEnum> get serializer =>
      _$advertGetLastPublicListDtoSortTypeEnumSerializer;

  const AdvertGetLastPublicListDtoSortTypeEnum._(String name) : super(name);

  static BuiltSet<AdvertGetLastPublicListDtoSortTypeEnum> get values =>
      _$advertGetLastPublicListDtoSortTypeEnumValues;
  static AdvertGetLastPublicListDtoSortTypeEnum valueOf(String name) =>
      _$advertGetLastPublicListDtoSortTypeEnumValueOf(name);
}
