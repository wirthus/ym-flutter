...
/// * [description]
@BuiltValue()
abstract class UserUpdateDto
    implements Built<UserUpdateDto, UserUpdateDtoBuilder> {
  ...
  factory UserUpdateDto([void updates(UserUpdateDtoBuilder b)]) =
      _$UserUpdateDto;
  ...
  static Serializer<UserUpdateDto> get serializer =>
      _$UserUpdateDtoSerializer();
}
...
class UserUpdateDtoTypeEnum extends EnumClass {
  ...
  static Serializer<UserUpdateDtoTypeEnum> get serializer =>
      _$userUpdateDtoTypeEnumSerializer;

  const UserUpdateDtoTypeEnum._(String name) : super(name);

  static BuiltSet<UserUpdateDtoTypeEnum> get values =>
      _$userUpdateDtoTypeEnumValues;
  static UserUpdateDtoTypeEnum valueOf(String name) =>
      _$userUpdateDtoTypeEnumValueOf(name);
}
