...
/// * [name]
@BuiltValue()
abstract class CleaningEntity
    implements Built<CleaningEntity, CleaningEntityBuilder> {
  ...
  factory CleaningEntity([void updates(CleaningEntityBuilder b)]) =
      _$CleaningEntity;
  ...
  static Serializer<CleaningEntity> get serializer =>
      _$CleaningEntitySerializer();
}

class _$CleaningEntitySerializer
    implements PrimitiveSerializer<CleaningEntity> {
  @override
