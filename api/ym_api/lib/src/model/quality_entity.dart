...
/// * [name]
@BuiltValue()
abstract class QualityEntity
    implements Built<QualityEntity, QualityEntityBuilder> {
  ...
  factory QualityEntity([void updates(QualityEntityBuilder b)]) =
      _$QualityEntity;
  ...
  static Serializer<QualityEntity> get serializer =>
      _$QualityEntitySerializer();
}
