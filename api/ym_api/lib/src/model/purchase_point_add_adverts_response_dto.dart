...
/// * [advertIds]
@BuiltValue()
abstract class PurchasePointAddAdvertsResponseDto
    implements
        Built<PurchasePointAddAdvertsResponseDto,
  ...
  factory PurchasePointAddAdvertsResponseDto(
          [void updates(PurchasePointAddAdvertsResponseDtoBuilder b)]) =
      _$PurchasePointAddAdvertsResponseDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PurchasePointAddAdvertsResponseDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PurchasePointAddAdvertsResponseDto> get serializer =>
      _$PurchasePointAddAdvertsResponseDtoSerializer();
}

class _$PurchasePointAddAdvertsResponseDtoSerializer
    implements PrimitiveSerializer<PurchasePointAddAdvertsResponseDto> {
  @override
