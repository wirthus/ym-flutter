...
/// * [name]
@BuiltValue()
abstract class PackingEntity
    implements Built<PackingEntity, PackingEntityBuilder> {
  ...
  factory PackingEntity([void updates(PackingEntityBuilder b)]) =
      _$PackingEntity;
  ...
  static Serializer<PackingEntity> get serializer =>
      _$PackingEntitySerializer();
}
