...
/// * [limit]
@BuiltValue()
abstract class NotificationGetListCountDto
    implements
        Built<NotificationGetListCountDto, NotificationGetListCountDtoBuilder> {
  ...
  factory NotificationGetListCountDto(
          [void updates(NotificationGetListCountDtoBuilder b)]) =
      _$NotificationGetListCountDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(NotificationGetListCountDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<NotificationGetListCountDto> get serializer =>
      _$NotificationGetListCountDtoSerializer();
}

class _$NotificationGetListCountDtoSerializer
    implements PrimitiveSerializer<NotificationGetListCountDto> {
  @override
