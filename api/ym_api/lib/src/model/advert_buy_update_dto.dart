...
/// * [description]
@BuiltValue()
abstract class AdvertBuyUpdateDto
    implements Built<AdvertBuyUpdateDto, AdvertBuyUpdateDtoBuilder> {
  ...
  factory AdvertBuyUpdateDto([void updates(AdvertBuyUpdateDtoBuilder b)]) =
      _$AdvertBuyUpdateDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AdvertBuyUpdateDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AdvertBuyUpdateDto> get serializer =>
      _$AdvertBuyUpdateDtoSerializer();
}

class _$AdvertBuyUpdateDtoSerializer
    implements PrimitiveSerializer<AdvertBuyUpdateDto> {
  @override
