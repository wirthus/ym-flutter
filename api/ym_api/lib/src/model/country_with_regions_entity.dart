...
/// * [regions]
@BuiltValue()
abstract class CountryWithRegionsEntity
    implements
        Built<CountryWithRegionsEntity, CountryWithRegionsEntityBuilder> {
  ...
  factory CountryWithRegionsEntity(
          [void updates(CountryWithRegionsEntityBuilder b)]) =
      _$CountryWithRegionsEntity;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CountryWithRegionsEntityBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CountryWithRegionsEntity> get serializer =>
      _$CountryWithRegionsEntitySerializer();
}

class _$CountryWithRegionsEntitySerializer
    implements PrimitiveSerializer<CountryWithRegionsEntity> {
  @override
