...
/// * [advertIds]
@BuiltValue()
abstract class PurchasePointCloneAdvertsResponseDto
    implements
        Built<PurchasePointCloneAdvertsResponseDto,
  ...
  factory PurchasePointCloneAdvertsResponseDto(
          [void updates(PurchasePointCloneAdvertsResponseDtoBuilder b)]) =
      _$PurchasePointCloneAdvertsResponseDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PurchasePointCloneAdvertsResponseDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PurchasePointCloneAdvertsResponseDto> get serializer =>
      _$PurchasePointCloneAdvertsResponseDtoSerializer();
}

class _$PurchasePointCloneAdvertsResponseDtoSerializer
    implements PrimitiveSerializer<PurchasePointCloneAdvertsResponseDto> {
  @override
