...
/// * [advertBuy]
@BuiltValue()
abstract class PurchaseAdvertPublicEntity
    implements
        Built<PurchaseAdvertPublicEntity, PurchaseAdvertPublicEntityBuilder> {
  ...
  factory PurchaseAdvertPublicEntity(
          [void updates(PurchaseAdvertPublicEntityBuilder b)]) =
      _$PurchaseAdvertPublicEntity;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PurchaseAdvertPublicEntityBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PurchaseAdvertPublicEntity> get serializer =>
      _$PurchaseAdvertPublicEntitySerializer();
}

class _$PurchaseAdvertPublicEntitySerializer
    implements PrimitiveSerializer<PurchaseAdvertPublicEntity> {
  @override
      ...
      switch (key) {
        ...
        case r'moderate':
          final valueDes = serializers.deserialize(
            value,
            specifiedType:
                const FullType(PurchaseAdvertPublicEntityModerateEnum),
...
class PurchaseAdvertPublicEntityModerateEnum extends EnumClass {
  ...
  static const PurchaseAdvertPublicEntityModerateEnum n0 =
      _$purchaseAdvertPublicEntityModerateEnum_n0;
  @BuiltValueEnumConst(wireName: r'1')
  static const PurchaseAdvertPublicEntityModerateEnum n1 =
      _$purchaseAdvertPublicEntityModerateEnum_n1;
  @BuiltValueEnumConst(wireName: r'2')
  static const PurchaseAdvertPublicEntityModerateEnum n2 =
      _$purchaseAdvertPublicEntityModerateEnum_n2;

  static Serializer<PurchaseAdvertPublicEntityModerateEnum> get serializer =>
      _$purchaseAdvertPublicEntityModerateEnumSerializer;

  const PurchaseAdvertPublicEntityModerateEnum._(String name) : super(name);

  static BuiltSet<PurchaseAdvertPublicEntityModerateEnum> get values =>
      _$purchaseAdvertPublicEntityModerateEnumValues;
  static PurchaseAdvertPublicEntityModerateEnum valueOf(String name) =>
      _$purchaseAdvertPublicEntityModerateEnumValueOf(name);
}
