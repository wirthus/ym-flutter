...
/// * [updatedAdvertIds]
@BuiltValue()
abstract class PurchasePointSetAdvertEnabledResponseDto
    implements
        Built<PurchasePointSetAdvertEnabledResponseDto,
  ...
  factory PurchasePointSetAdvertEnabledResponseDto(
          [void updates(PurchasePointSetAdvertEnabledResponseDtoBuilder b)]) =
      _$PurchasePointSetAdvertEnabledResponseDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PurchasePointSetAdvertEnabledResponseDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PurchasePointSetAdvertEnabledResponseDto> get serializer =>
      _$PurchasePointSetAdvertEnabledResponseDtoSerializer();
}

class _$PurchasePointSetAdvertEnabledResponseDtoSerializer
    implements PrimitiveSerializer<PurchasePointSetAdvertEnabledResponseDto> {
  @override
