...
/// * [address]
@BuiltValue()
abstract class PurchasePointCreateDto
    implements Built<PurchasePointCreateDto, PurchasePointCreateDtoBuilder> {
  ...
  factory PurchasePointCreateDto(
          [void updates(PurchasePointCreateDtoBuilder b)]) =
      _$PurchasePointCreateDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PurchasePointCreateDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PurchasePointCreateDto> get serializer =>
      _$PurchasePointCreateDtoSerializer();
}

class _$PurchasePointCreateDtoSerializer
    implements PrimitiveSerializer<PurchasePointCreateDto> {
  @override
