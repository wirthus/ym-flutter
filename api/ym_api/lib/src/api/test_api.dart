...
class TestApi {
  ...
  Future<Response<void>> testControllerAutoFillRegions({
    ...
    final _path = r'/test/regions/auto-fill';
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<num>> testControllerFillAdvertsLocation({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/test/adverts/fill-location';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [num] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<num>> testControllerFillAdvertsRegion({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/test/adverts/fill-region';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<BuiltList<String>>> testControllerFillRegionsLocation({
    ...
    final _path = r'/test/regions/fill-location';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
