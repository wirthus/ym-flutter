...
class ProductsApi {
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ProductGroupWithProductsEntity>>
      productControllerGetGroupWithProducts({
    required num id,
    bool? subGroups,
    CancelToken? cancelToken,
    ...
    final _path = r'/products/groups/{id}/full'.replaceAll('{' r'id' '}',
        encodeQueryParameter(_serializers, id, const FullType(num)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
    ...
    final _queryParameters = <String, dynamic>{
      if (subGroups != null)
        r'subGroups':
            encodeQueryParameter(_serializers, subGroups, const FullType(bool)),
    };
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<GroupProductsCountEntity>>>
      productControllerGetGroupsProductsCount({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              ...
              specifiedType: const FullType(
                  BuiltList, [FullType(GroupProductsCountEntity)]),
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<ProductGroupWithProductsEntity>>>
      productControllerGetGroupsWithProducts({
    bool? subGroups,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(
                  BuiltList, [FullType(ProductGroupWithProductsEntity)]),
  ...
  Future<Response<ProductInfoEntity>> productControllerGetInfo({
    ...
    final _path = r'/products/{id}/info'.replaceAll('{' r'id' '}',
        encodeQueryParameter(_serializers, id, const FullType(num)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<ProductEntity>>>
      productControllerGetProductsByGroup({
    required num id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/products/groups/{id}'.replaceAll('{' r'id' '}',
        encodeQueryParameter(_serializers, id, const FullType(num)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
  ...
  /// Returns a [Future] containing a [Response] with a [BuiltList<ProductGroupEntity>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<ProductGroupEntity>>>
      productControllerGetSubGroups({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<ProductSubGroupEntity>>>
      productControllerGetSubGroupsByProductId({
    required num id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/products/{id}/subGroups'.replaceAll('{' r'id' '}',
        encodeQueryParameter(_serializers, id, const FullType(num)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<ProductSearchResultEntity>>>
      productControllerSearchEx({
    ...
    try {
      ...
      _bodyData = _serializers.serialize(searchProductAdvancedDto,
          specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(
                  BuiltList, [FullType(ProductSearchResultEntity)]),
