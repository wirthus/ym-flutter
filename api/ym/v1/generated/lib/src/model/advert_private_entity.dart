...
/// * [createdAt] 
@BuiltValue()
abstract class AdvertPrivateEntity implements Built<AdvertPrivateEntity, AdvertPrivateEntityBuilder> {
  ...
  factory AdvertPrivateEntity([void updates(AdvertPrivateEntityBuilder b)]) = _$AdvertPrivateEntity;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AdvertPrivateEntityBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AdvertPrivateEntity> get serializer => _$AdvertPrivateEntitySerializer();
}

class _$AdvertPrivateEntitySerializer implements PrimitiveSerializer<AdvertPrivateEntity> {
  @override
  final Iterable<Type> types = const [AdvertPrivateEntity, _$AdvertPrivateEntity];
  ...
  Iterable<Object?> _serializeProperties(
    ...
    yield object.moderateComment == null ? null : serializers.serialize(
...
class AdvertPrivateEntityModerateEnum extends EnumClass {
  ...
  static const AdvertPrivateEntityModerateEnum n0 = _$advertPrivateEntityModerateEnum_n0;
  @BuiltValueEnumConst(wireName: r'1')
  static const AdvertPrivateEntityModerateEnum n1 = _$advertPrivateEntityModerateEnum_n1;
  @BuiltValueEnumConst(wireName: r'2')
  static const AdvertPrivateEntityModerateEnum n2 = _$advertPrivateEntityModerateEnum_n2;

  static Serializer<AdvertPrivateEntityModerateEnum> get serializer => _$advertPrivateEntityModerateEnumSerializer;

  const AdvertPrivateEntityModerateEnum._(String name): super(name);

  static BuiltSet<AdvertPrivateEntityModerateEnum> get values => _$advertPrivateEntityModerateEnumValues;
  static AdvertPrivateEntityModerateEnum valueOf(String name) => _$advertPrivateEntityModerateEnumValueOf(name);
}
