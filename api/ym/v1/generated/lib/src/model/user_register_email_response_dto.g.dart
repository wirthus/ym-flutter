...
UserRegisterEmailResponseDto _$UserRegisterEmailResponseDtoFromJson(
    ...
    $checkedCreate(
      ...
      ($checkedConvert) {
        ...
        final val = UserRegisterEmailResponseDto(
...
Map<String, dynamic> _$UserRegisterEmailResponseDtoToJson(
        UserRegisterEmailResponseDto instance) =>
    <String, dynamic>{
      'id': instance.id,
      'name': instance.name,
