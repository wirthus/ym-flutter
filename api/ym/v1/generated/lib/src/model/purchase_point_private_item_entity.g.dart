...
PurchasePointPrivateItemEntity _$PurchasePointPrivateItemEntityFromJson(
    ...
    $checkedCreate(
      ...
      ($checkedConvert) {
        ...
        final val = PurchasePointPrivateItemEntity(
...
Map<String, dynamic> _$PurchasePointPrivateItemEntityToJson(
        PurchasePointPrivateItemEntity instance) =>
    <String, dynamic>{
      'id': instance.id,
