...
/// * [purchasePointIds] 
@BuiltValue()
abstract class AdvertBuyRemovePurchasePointsDto implements Built<AdvertBuyRemovePurchasePointsDto, AdvertBuyRemovePurchasePointsDtoBuilder> {
  @BuiltValueField(wireName: r'purchasePointIds')
  BuiltList<num> get purchasePointIds;

  AdvertBuyRemovePurchasePointsDto._();

  factory AdvertBuyRemovePurchasePointsDto([void updates(AdvertBuyRemovePurchasePointsDtoBuilder b)]) = _$AdvertBuyRemovePurchasePointsDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AdvertBuyRemovePurchasePointsDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AdvertBuyRemovePurchasePointsDto> get serializer => _$AdvertBuyRemovePurchasePointsDtoSerializer();
}

class _$AdvertBuyRemovePurchasePointsDtoSerializer implements PrimitiveSerializer<AdvertBuyRemovePurchasePointsDto> {
  @override
  final Iterable<Type> types = const [AdvertBuyRemovePurchasePointsDto, _$AdvertBuyRemovePurchasePointsDto];
