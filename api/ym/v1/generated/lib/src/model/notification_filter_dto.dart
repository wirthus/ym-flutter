...
class NotificationFilterDtoTypeEnum extends EnumClass {
  ...
  static const NotificationFilterDtoTypeEnum system = _$notificationFilterDtoTypeEnum_system;
  @BuiltValueEnumConst(wireName: r'subscription')
  static const NotificationFilterDtoTypeEnum subscription = _$notificationFilterDtoTypeEnum_subscription;
  @BuiltValueEnumConst(wireName: r'user')
  static const NotificationFilterDtoTypeEnum user = _$notificationFilterDtoTypeEnum_user;

  static Serializer<NotificationFilterDtoTypeEnum> get serializer => _$notificationFilterDtoTypeEnumSerializer;

  const NotificationFilterDtoTypeEnum._(String name): super(name);

  static BuiltSet<NotificationFilterDtoTypeEnum> get values => _$notificationFilterDtoTypeEnumValues;
  static NotificationFilterDtoTypeEnum valueOf(String name) => _$notificationFilterDtoTypeEnumValueOf(name);
}

class NotificationFilterDtoStatusEnum extends EnumClass {

  @BuiltValueEnumConst(wireName: r'unread')
  static const NotificationFilterDtoStatusEnum unread = _$notificationFilterDtoStatusEnum_unread;
  @BuiltValueEnumConst(wireName: r'read')
  static const NotificationFilterDtoStatusEnum read = _$notificationFilterDtoStatusEnum_read;
  @BuiltValueEnumConst(wireName: r'archived')
  static const NotificationFilterDtoStatusEnum archived = _$notificationFilterDtoStatusEnum_archived;

  static Serializer<NotificationFilterDtoStatusEnum> get serializer => _$notificationFilterDtoStatusEnumSerializer;

  const NotificationFilterDtoStatusEnum._(String name): super(name);

  static BuiltSet<NotificationFilterDtoStatusEnum> get values => _$notificationFilterDtoStatusEnumValues;
  static NotificationFilterDtoStatusEnum valueOf(String name) => _$notificationFilterDtoStatusEnumValueOf(name);
}
