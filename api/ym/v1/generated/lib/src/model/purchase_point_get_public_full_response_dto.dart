...
/// * [region] 
@BuiltValue()
abstract class PurchasePointGetPublicFullResponseDto implements Built<PurchasePointGetPublicFullResponseDto, PurchasePointGetPublicFullResponseDtoBuilder> {
  ...
  factory PurchasePointGetPublicFullResponseDto([void updates(PurchasePointGetPublicFullResponseDtoBuilder b)]) = _$PurchasePointGetPublicFullResponseDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PurchasePointGetPublicFullResponseDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PurchasePointGetPublicFullResponseDto> get serializer => _$PurchasePointGetPublicFullResponseDtoSerializer();
}

class _$PurchasePointGetPublicFullResponseDtoSerializer implements PrimitiveSerializer<PurchasePointGetPublicFullResponseDto> {
  @override
  final Iterable<Type> types = const [PurchasePointGetPublicFullResponseDto, _$PurchasePointGetPublicFullResponseDto];
