...
/// * [companyInn] 
@BuiltValue()
abstract class UserPublicMobileEntity implements Built<UserPublicMobileEntity, UserPublicMobileEntityBuilder> {
  ...
  factory UserPublicMobileEntity([void updates(UserPublicMobileEntityBuilder b)]) = _$UserPublicMobileEntity;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(UserPublicMobileEntityBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<UserPublicMobileEntity> get serializer => _$UserPublicMobileEntitySerializer();
}

class _$UserPublicMobileEntitySerializer implements PrimitiveSerializer<UserPublicMobileEntity> {
  @override
  final Iterable<Type> types = const [UserPublicMobileEntity, _$UserPublicMobileEntity];
