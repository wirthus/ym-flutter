...
class AdvertBuyGetListDtoOrderByEnum extends EnumClass {
  ...
  static const AdvertBuyGetListDtoOrderByEnum name = _$advertBuyGetListDtoOrderByEnum_name;
  @BuiltValueEnumConst(wireName: r'createdAt')
  static const AdvertBuyGetListDtoOrderByEnum createdAt = _$advertBuyGetListDtoOrderByEnum_createdAt;

  static Serializer<AdvertBuyGetListDtoOrderByEnum> get serializer => _$advertBuyGetListDtoOrderByEnumSerializer;

  const AdvertBuyGetListDtoOrderByEnum._(String name): super(name);

  static BuiltSet<AdvertBuyGetListDtoOrderByEnum> get values => _$advertBuyGetListDtoOrderByEnumValues;
  static AdvertBuyGetListDtoOrderByEnum valueOf(String name) => _$advertBuyGetListDtoOrderByEnumValueOf(name);
}
