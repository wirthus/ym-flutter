...
class AdvertSearchDtoSortTypeEnum extends EnumClass {
  ...
  static const AdvertSearchDtoSortTypeEnum dateAsc = _$advertSearchDtoSortTypeEnum_dateAsc;
  @BuiltValueEnumConst(wireName: r'date_desc')
  static const AdvertSearchDtoSortTypeEnum dateDesc = _$advertSearchDtoSortTypeEnum_dateDesc;
  @BuiltValueEnumConst(wireName: r'price_asc')
  static const AdvertSearchDtoSortTypeEnum priceAsc = _$advertSearchDtoSortTypeEnum_priceAsc;
  @BuiltValueEnumConst(wireName: r'price_desc')
  static const AdvertSearchDtoSortTypeEnum priceDesc = _$advertSearchDtoSortTypeEnum_priceDesc;
  @BuiltValueEnumConst(wireName: r'quantity_asc')
  static const AdvertSearchDtoSortTypeEnum quantityAsc = _$advertSearchDtoSortTypeEnum_quantityAsc;
  @BuiltValueEnumConst(wireName: r'quantity_desc')
  static const AdvertSearchDtoSortTypeEnum quantityDesc = _$advertSearchDtoSortTypeEnum_quantityDesc;

  static Serializer<AdvertSearchDtoSortTypeEnum> get serializer => _$advertSearchDtoSortTypeEnumSerializer;

  const AdvertSearchDtoSortTypeEnum._(String name): super(name);

  static BuiltSet<AdvertSearchDtoSortTypeEnum> get values => _$advertSearchDtoSortTypeEnumValues;
  static AdvertSearchDtoSortTypeEnum valueOf(String name) => _$advertSearchDtoSortTypeEnumValueOf(name);
}
