...
/// * [recyclingItems] 
@BuiltValue()
abstract class ProductInfoEntity implements Built<ProductInfoEntity, ProductInfoEntityBuilder> {
  ...
  factory ProductInfoEntity([void updates(ProductInfoEntityBuilder b)]) = _$ProductInfoEntity;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ProductInfoEntityBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ProductInfoEntity> get serializer => _$ProductInfoEntitySerializer();
}

class _$ProductInfoEntitySerializer implements PrimitiveSerializer<ProductInfoEntity> {
  @override
