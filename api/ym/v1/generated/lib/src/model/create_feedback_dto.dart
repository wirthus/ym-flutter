...
/// * [message] 
@BuiltValue()
abstract class CreateFeedbackDto implements Built<CreateFeedbackDto, CreateFeedbackDtoBuilder> {
  ...
  factory CreateFeedbackDto([void updates(CreateFeedbackDtoBuilder b)]) = _$CreateFeedbackDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CreateFeedbackDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CreateFeedbackDto> get serializer => _$CreateFeedbackDtoSerializer();
}

class _$CreateFeedbackDtoSerializer implements PrimitiveSerializer<CreateFeedbackDto> {
  @override
