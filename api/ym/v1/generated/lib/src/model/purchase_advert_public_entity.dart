...
part 'purchase_advert_public_entity.g.dart';
...
/// * [advertBuy] 
@BuiltValue()
abstract class PurchaseAdvertPublicEntity implements Built<PurchaseAdvertPublicEntity, PurchaseAdvertPublicEntityBuilder> {
  ...
  PurchaseAdvertPublicEntityModerateEnum get moderate;
  ...
  PurchaseAdvertPublicEntity._();

  factory PurchaseAdvertPublicEntity([void updates(PurchaseAdvertPublicEntityBuilder b)]) = _$PurchaseAdvertPublicEntity;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PurchaseAdvertPublicEntityBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PurchaseAdvertPublicEntity> get serializer => _$PurchaseAdvertPublicEntitySerializer();
}

class _$PurchaseAdvertPublicEntitySerializer implements PrimitiveSerializer<PurchaseAdvertPublicEntity> {
  @override
  final Iterable<Type> types = const [PurchaseAdvertPublicEntity, _$PurchaseAdvertPublicEntity];

  @override
  final String wireName = r'PurchaseAdvertPublicEntity';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    PurchaseAdvertPublicEntity object, {
    ...
    yield serializers.serialize(
      object.moderate,
      specifiedType: const FullType(PurchaseAdvertPublicEntityModerateEnum),
    );
    yield r'price';
    yield serializers.serialize(
      object.price,
    ...
    yield serializers.serialize(
      object.advertBuy,
      specifiedType: const FullType(AdvertBuyPublicEntity),
    );
  }
  ...
  void _deserializeProperties(
    ...
    required PurchaseAdvertPublicEntityBuilder result,
      ...
      switch (key) {
        ...
        case r'moderate':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(PurchaseAdvertPublicEntityModerateEnum),
          ) as PurchaseAdvertPublicEntityModerateEnum;
  ...
  @override
  PurchaseAdvertPublicEntity deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = PurchaseAdvertPublicEntityBuilder();
...
class PurchaseAdvertPublicEntityModerateEnum extends EnumClass {

  @BuiltValueEnumConst(wireName: r'0')
  static const PurchaseAdvertPublicEntityModerateEnum n0 = _$purchaseAdvertPublicEntityModerateEnum_n0;
  @BuiltValueEnumConst(wireName: r'1')
  static const PurchaseAdvertPublicEntityModerateEnum n1 = _$purchaseAdvertPublicEntityModerateEnum_n1;
  @BuiltValueEnumConst(wireName: r'2')
  static const PurchaseAdvertPublicEntityModerateEnum n2 = _$purchaseAdvertPublicEntityModerateEnum_n2;

  static Serializer<PurchaseAdvertPublicEntityModerateEnum> get serializer => _$purchaseAdvertPublicEntityModerateEnumSerializer;

  const PurchaseAdvertPublicEntityModerateEnum._(String name): super(name);

  static BuiltSet<PurchaseAdvertPublicEntityModerateEnum> get values => _$purchaseAdvertPublicEntityModerateEnumValues;
  static PurchaseAdvertPublicEntityModerateEnum valueOf(String name) => _$purchaseAdvertPublicEntityModerateEnumValueOf(name);
}
