...
/// * [name] 
@BuiltValue()
abstract class ProductSearchResultEntity implements Built<ProductSearchResultEntity, ProductSearchResultEntityBuilder> {
  ...
  factory ProductSearchResultEntity([void updates(ProductSearchResultEntityBuilder b)]) = _$ProductSearchResultEntity;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ProductSearchResultEntityBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ProductSearchResultEntity> get serializer => _$ProductSearchResultEntitySerializer();
}

class _$ProductSearchResultEntitySerializer implements PrimitiveSerializer<ProductSearchResultEntity> {
  @override
  final Iterable<Type> types = const [ProductSearchResultEntity, _$ProductSearchResultEntity];
  ...
  Iterable<Object?> _serializeProperties(
    ...
    yield r'subgroup_id';
    yield object.subgroupId == null ? null : serializers.serialize(
      object.subgroupId,
      specifiedType: const FullType.nullable(num),
    );
    yield r'name';
