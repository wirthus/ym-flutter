...
/// * [adverts] 
@BuiltValue()
abstract class AdvertBuyGetListResponseDto implements Built<AdvertBuyGetListResponseDto, AdvertBuyGetListResponseDtoBuilder> {
  @BuiltValueField(wireName: r'adverts')
  BuiltList<AdvertBuyEntity> get adverts;

  AdvertBuyGetListResponseDto._();

  factory AdvertBuyGetListResponseDto([void updates(AdvertBuyGetListResponseDtoBuilder b)]) = _$AdvertBuyGetListResponseDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AdvertBuyGetListResponseDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AdvertBuyGetListResponseDto> get serializer => _$AdvertBuyGetListResponseDtoSerializer();
}

class _$AdvertBuyGetListResponseDtoSerializer implements PrimitiveSerializer<AdvertBuyGetListResponseDto> {
  @override
  final Iterable<Type> types = const [AdvertBuyGetListResponseDto, _$AdvertBuyGetListResponseDto];
