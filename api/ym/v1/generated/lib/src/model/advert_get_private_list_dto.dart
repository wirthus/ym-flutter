...
/// * [filters] 
@BuiltValue()
abstract class AdvertGetPrivateListDto implements Built<AdvertGetPrivateListDto, AdvertGetPrivateListDtoBuilder> {
  @BuiltValueField(wireName: r'filters')
  BuiltList<AdvertFilterDto>? get filters;

  AdvertGetPrivateListDto._();

  factory AdvertGetPrivateListDto([void updates(AdvertGetPrivateListDtoBuilder b)]) = _$AdvertGetPrivateListDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AdvertGetPrivateListDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AdvertGetPrivateListDto> get serializer => _$AdvertGetPrivateListDtoSerializer();
}

class _$AdvertGetPrivateListDtoSerializer implements PrimitiveSerializer<AdvertGetPrivateListDto> {
  @override
  final Iterable<Type> types = const [AdvertGetPrivateListDto, _$AdvertGetPrivateListDto];
