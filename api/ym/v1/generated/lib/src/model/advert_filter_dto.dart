...
class AdvertFilterDtoModerateEnum extends EnumClass {
  ...
  static const AdvertFilterDtoModerateEnum n0 = _$advertFilterDtoModerateEnum_n0;
  @BuiltValueEnumConst(wireName: r'1')
  static const AdvertFilterDtoModerateEnum n1 = _$advertFilterDtoModerateEnum_n1;
  @BuiltValueEnumConst(wireName: r'2')
  static const AdvertFilterDtoModerateEnum n2 = _$advertFilterDtoModerateEnum_n2;

  static Serializer<AdvertFilterDtoModerateEnum> get serializer => _$advertFilterDtoModerateEnumSerializer;

  const AdvertFilterDtoModerateEnum._(String name): super(name);

  static BuiltSet<AdvertFilterDtoModerateEnum> get values => _$advertFilterDtoModerateEnumValues;
  static AdvertFilterDtoModerateEnum valueOf(String name) => _$advertFilterDtoModerateEnumValueOf(name);
}
...
class AdvertFilterDtoStatusEnum extends EnumClass {
  ...
  static Serializer<AdvertFilterDtoStatusEnum> get serializer => _$advertFilterDtoStatusEnumSerializer;

  const AdvertFilterDtoStatusEnum._(String name): super(name);

  static BuiltSet<AdvertFilterDtoStatusEnum> get values => _$advertFilterDtoStatusEnumValues;
  static AdvertFilterDtoStatusEnum valueOf(String name) => _$advertFilterDtoStatusEnumValueOf(name);
}
