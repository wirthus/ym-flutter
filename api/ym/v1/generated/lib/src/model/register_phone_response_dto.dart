...
/// * [expirationDate] 
@BuiltValue()
abstract class RegisterPhoneResponseDto implements Built<RegisterPhoneResponseDto, RegisterPhoneResponseDtoBuilder> {
  ...
  factory RegisterPhoneResponseDto([void updates(RegisterPhoneResponseDtoBuilder b)]) = _$RegisterPhoneResponseDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(RegisterPhoneResponseDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<RegisterPhoneResponseDto> get serializer => _$RegisterPhoneResponseDtoSerializer();
}

class _$RegisterPhoneResponseDtoSerializer implements PrimitiveSerializer<RegisterPhoneResponseDto> {
  @override
  final Iterable<Type> types = const [RegisterPhoneResponseDto, _$RegisterPhoneResponseDto];
