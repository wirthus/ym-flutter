...
class CountriesApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [CountryWithRegionsEntity] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CountryWithRegionsEntity>> countryControllerGet({ 
    required String id,
    ...
    return Response<CountryWithRegionsEntity>(
      data: _responseData,
