...
class NotificationsApi {
  ...
  Future<Response<PaginatedResponseOfNotificationAdvertEntity>> notificationControllerGetAdverts({ 
    required PaginatedBodyOfNotificationGetListAdvertsDto paginatedBodyOfNotificationGetListAdvertsDto,
  ...
  Future<Response<num>> notificationControllerGetAdvertsCount({ 
    required NotificationGetListAdvertsCountDto notificationGetListAdvertsCountDto,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
