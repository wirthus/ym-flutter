...
class ProductsApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [ProductEntity] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ProductEntity>> productControllerCreate({ 
  ...
  /// Returns a [Future] containing a [Response] with a [ProductEntity] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ProductEntity>> productControllerGet({ 
    required int id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ProductGroupWithProductsEntity] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ProductGroupWithProductsEntity>> productControllerGetGroupWithProducts({ 
    required int id,
    bool? subGroups,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/products/groups/{id}/full'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(int)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    return Response<ProductGroupWithProductsEntity>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<BuiltList<GroupProductsCountEntity>>> productControllerGetGroupsProductsCount({ 
    ...
    final _path = r'/products/groups/products/count';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<BuiltList<ProductGroupWithProductsEntity>>> productControllerGetGroupsWithProducts({ 
    ...
    final _path = r'/products/groups/full';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ProductInfoEntity] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ProductInfoEntity>> productControllerGetInfo({ 
    required int id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/products/{id}/info'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(int)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    return Response<ProductInfoEntity>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<BuiltList<ProductEntity>>> productControllerGetProductsByGroup({ 
    ...
    final _path = r'/products/groups/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(int)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<BuiltList<ProductGroupEntity>>> productControllerGetSubGroups({ 
    ...
    final _path = r'/products/subGroups';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<BuiltList<ProductSubGroupEntity>>> productControllerGetSubGroupsByProductId({ 
    ...
    final _path = r'/products/{id}/subGroups'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(int)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<BuiltList<ProductSearchResultEntity>>> productControllerSearchEx({ 
    ...
    final _path = r'/products/search-ex';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
